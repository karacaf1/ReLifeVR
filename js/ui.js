...
function showPanel(name) {
	...
	setVisible("#playMenuPanel", name === "play");
...
function setMenuOpen(open) {
	...
	if (!open) {
		...
		setVisible("#playMenuPanel", false);
...
function setupMenuUi() {
	...
	onClick("#btnPlay", () => {
		...
		const note = document.querySelector("#supermarketNotice");
		if (note) {
